...
# remove exactly identical consecutive block if possible, or just parse dictionary and write it out.
# wait, parsing with JS to JSON is hard. Let's just find duplicates block by block using regex.
block_to_find = """    "recharge_digital_desc": "Agrega fondos a tu balance usando tarjeta, Yappy u otros métodos digitales.",
...
"""
text = text.replace(block_to_find, "", 1)

block_zh = """    "recharge_digital_desc": "使用卡、Yappy 或其他数字方法为您的余额添加资金。",
