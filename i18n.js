const translations = {
  "es": {
    ...
    "checkout_pay_now": "Confirmar pago",
...
,
  ...
  "checkout_title": "Punto Pago — Cobro y recarga (demo)",
  "checkout_nav_title": "Punto Pago",
  "checkout_nav_subtitle": "Pagos",
  "checkout_available_balance": "Saldo",
  "checkout_heading": "Completar pago",
  "checkout_price_total": "Importe de esta operación:",
  "checkout_order_context_label": "Operación",
  "checkout_demo_short": "Prueba · sin validar datos",
  "checkout_slide_card_title": "Tarjeta",
  "checkout_slide_card_hint": "Visa o Mastercard",
  "checkout_slide_clave_title": "Clave",
  "checkout_slide_clave_hint": "Tarjeta Panamá",
  "checkout_slide_yappy_title": "Yappy",
  "checkout_slide_yappy_hint": "Desde el celular",
  "checkout_slide_paypal_title": "PayPal",
  "checkout_slide_paypal_hint": "Cuenta PayPal",
  "checkout_slide_gpay_title": "Google Pay",
  "checkout_slide_gpay_hint": "Wallet Google",
  "checkout_slide_apple_title": "Apple Pay",
  "checkout_slide_apple_hint": "Wallet Apple",
  ...
  "checkout_select_method_legend": "Cómo quieres pagar",
  ...
  "checkout_demo_note": "Simulación: no se procesa un cobro real.",
  "checkout_agent_success_title_topup": "Recarga aplicada",
  "checkout_agent_success_title_service": "Pago de servicio registrado",
  "checkout_agent_success_title_credit": "Saldo actualizado",
  "checkout_agent_success_lead": "Los cambios ya están guardados en el sandbox de este navegador.",
  "checkout_agent_fact_gross": "Monto de la operación",
  "checkout_agent_fact_net": "Acreditado en saldo (neto)",
  "checkout_agent_fact_fees": "Comisión + ITBMS (estimado)",
  "checkout_agent_fact_commission": "Comisión registrada",
  "checkout_agent_fact_balance": "Saldo operativo ahora",
  "checkout_agent_fact_cash": "Efectivo (caja) ahora",
  "checkout_agent_fact_tx": "ID de transacción",
  "checkout_agent_success_demo": "Demo: sin pasarela real. Vuelve al portal para seguir operando o revisa el histórico.",
  "checkout_agent_success_dismiss": "Cerrar",
  ...
  "checkout_title": "Punto Pago — Payments & top-up (demo)",
  "checkout_nav_title": "Punto Pago",
  "checkout_nav_subtitle": "Payments",
  "checkout_available_balance": "Balance",
  "checkout_heading": "Complete payment",
  "checkout_price_total": "Amount for this transaction:",
  "checkout_order_context_label": "Operation",
  "checkout_demo_short": "Test mode · skip validation",
  "checkout_slide_card_title": "Card",
  "checkout_slide_card_hint": "Visa or Mastercard",
  "checkout_slide_clave_title": "Clave",
  "checkout_slide_clave_hint": "Panama debit",
  "checkout_slide_yappy_title": "Yappy",
  "checkout_slide_yappy_hint": "From your phone",
  "checkout_slide_paypal_title": "PayPal",
  "checkout_slide_paypal_hint": "PayPal account",
  "checkout_slide_gpay_title": "Google Pay",
  "checkout_slide_gpay_hint": "Google wallet",
  "checkout_slide_apple_title": "Apple Pay",
  "checkout_slide_apple_hint": "Apple wallet",
  ...
  "checkout_select_method_legend": "How do you want to pay",
  ...
  "checkout_demo_note": "Simulation only — no real charge is processed.",
  "checkout_agent_success_title_topup": "Top-up applied",
  "checkout_agent_success_title_service": "Service payment recorded",
  "checkout_agent_success_title_credit": "Balance updated",
  "checkout_agent_success_lead": "Changes are saved in this browser's sandbox.",
  "checkout_agent_fact_gross": "Transaction amount",
  "checkout_agent_fact_net": "Credited to balance (net)",
  "checkout_agent_fact_fees": "Fee + tax (estimate)",
  "checkout_agent_fact_commission": "Commission recorded",
  "checkout_agent_fact_balance": "Operating balance now",
  "checkout_agent_fact_cash": "Cash (till) now",
  "checkout_agent_fact_tx": "Transaction ID",
  "checkout_agent_success_demo": "Demo: no real gateway. Return to the portal to continue or check history.",
  "checkout_agent_success_dismiss": "Close",
  "checkout_method_paypal": "PayPal",
  "checkout_method_gpay": "Google Pay",
  "checkout_method_apple": "Apple Pay",
  ...
  "checkout_agent_success_title_topup": "Пополнение выполнено",
  "checkout_agent_success_title_service": "Оплата услуги записана",
  "checkout_agent_success_title_credit": "Баланс обновлён",
  "checkout_agent_success_lead": "Изменения сохранены в песочнице этого браузера.",
  "checkout_agent_fact_gross": "Сумма операции",
  "checkout_agent_fact_net": "Зачислено на баланс (нетто)",
  "checkout_agent_fact_fees": "Комиссия + налог (оценка)",
  "checkout_agent_fact_commission": "Комиссия записана",
  "checkout_agent_fact_balance": "Операционный баланс",
  "checkout_agent_fact_cash": "Наличные (касса)",
  "checkout_agent_fact_tx": "ID транзакции",
  "checkout_agent_success_demo": "Демо: без реального шлюза. Вернитесь в портал.",
  "checkout_agent_success_dismiss": "Закрыть",
...
,
  ...
  "checkout_agent_success_title_topup": "充值已完成",
  "checkout_agent_success_title_service": "服务付款已记录",
  "checkout_agent_success_title_credit": "余额已更新",
  "checkout_agent_success_lead": "更改已保存在本浏览器沙盒中。",
  "checkout_agent_fact_gross": "交易金额",
  "checkout_agent_fact_net": "入账净额",
  "checkout_agent_fact_fees": "手续费 + 税（估算）",
  "checkout_agent_fact_commission": "已记佣金",
  "checkout_agent_fact_balance": "当前可用余额",
  "checkout_agent_fact_cash": "现金（收银）",
  "checkout_agent_fact_tx": "交易 ID",
  "checkout_agent_success_demo": "演示：非真实网关。可返回门户继续。",
  "checkout_agent_success_dismiss": "关闭",
