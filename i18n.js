...
,
  ...
  "checkout_nav_subtitle": "Cobro y recarga (demo)",
  "checkout_kicker": "Prototipo · sin cobro real",
  "checkout_available_balance": "Saldo en wallet",
  "checkout_heading": "Completar pago",
  "checkout_price_total": "Importe de esta operación:",
  "checkout_order_context_label": "Operación",
  "checkout_trust_1": "Misma línea visual que el resto del demo Punto Pago (violeta institucional).",
  "checkout_trust_2": "Visa, Mastercard y Clave: flujo pensado para Panamá, como en puntopago.net.",
  "checkout_trust_3": "Ambiente de prueba: ningún cargo se envía a una pasarela real.",
  ...
  "checkout_nav_title": "Punto Pago",
  "checkout_nav_subtitle": "Payments & top-up (demo)",
  "checkout_kicker": "Prototype · no real charge",
  "checkout_available_balance": "Wallet balance",
  "checkout_heading": "Complete payment",
  "checkout_price_total": "Amount for this transaction:",
  "checkout_order_context_label": "Operation",
  "checkout_trust_1": "Same visual line as the Punto Pago demo (institutional violet).",
  "checkout_trust_2": "Visa, Mastercard and Clave: flow oriented to Panama, like puntopago.net.",
  "checkout_trust_3": "Test environment: no charge is sent to a real gateway.",
