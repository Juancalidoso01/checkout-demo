...
es_vars = [
    ...
    '"agent_module_desc_dev": "Esta versión es la copia de trabajo del módulo de agente para desarrollo. Puedes editar este archivo y ver cambios directamente en /agents/.",',
    '"agent_balance": "Saldo",',
...
en_vars = [
    ...
    '"entry_desc": "Choose the flow type from which the payment is initiated. This is just a conceptual selector; choosing will open the checkout.",',
    ...
    '"entry_qr_desc": "Quick recharges and flows from a QR or card read.",',
    '"entry_web": "E-commerce / Web",',
    '"entry_web_desc": "Integrated checkout in online stores or web pages.",',
    ...
    '"agent_balance_desc": "Available balance to pay services or withdraw",',
...
ru_vars = [
    '"login_header": "Доступ",',
    '"login_demo_badge": "Демонстрация онлайн-банкинга (роли)",',
    '"login_title": "Войти",',
    ...
    '"entry_desc": "Выберите тип процесса, с которого начинается платеж. Это просто концептуальный селектор; при выборе откроется касса.",',
    ...
    '"entry_qr_desc": "Быстрые пополнения и процессы с QR-кода или чтения карты.",',
    '"entry_web": "Электронная коммерция / Web",',
    '"entry_web_desc": "Интегрированная касса в интернет-магазинах или на веб-страницах.",',
    '"entry_agent": "Модуль агента",',
    '"entry_agent_desc": "Просмотр баланса, сбор услуг, просмотр доходов и истории транзакций.",',
    ...
    '"agent_module_desc": "Тестовая панель: баланс, сборы, доходы и история. В этом демо используется локальное хранилище для симуляции состояния.",',
    '"agent_module_desc_dev": "Эта версия является рабочей копией модуля агента для разработки.",',
    '"agent_balance": "Баланс",',
    '"agent_balance_desc": "Доступный баланс для оплаты услуг или снятия",',
    ...
    '"agent_dash_desc": "Накопленные доходы и быстрые метрики",',
